...
import net.gy.quest.client.renderer.*;
...
public class DeliveranceClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRenderers.register(ModEntityTypes.SUMMONED_ZOMBIE, SummonedZombieRenderer::new);
        EntityRenderers.register(ModEntityTypes.SUMMONED_SKELETON, SummonedSkeletonRenderer::new);
