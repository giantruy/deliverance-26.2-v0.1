...
public class Items {
	...
	public static final Item FURNACE = registerBlock(BlockItemIds.FURNACE, Blocks.FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
	...
	public static final Item LIGHT = registerBlock(
		BlockItemIds.LIGHT, Blocks.LIGHT, p -> p.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15))
	);
	...
	public static final ColorCollection<Item> CARPET = ColorCollection.registerBlockItems(
		BlockItemIds.CARPET, Blocks.CARPET, (id, block, color) -> registerBlock(id, block, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(color)))
	);
	...
	public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
		BlockItemIds.DEAD_TUBE_CORAL_FAN, Blocks.DEAD_TUBE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, p)
	);
	...
	public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
		BlockItemIds.DEAD_FIRE_CORAL_FAN, Blocks.DEAD_FIRE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, p)
	);
	public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
		BlockItemIds.DEAD_HORN_CORAL_FAN, Blocks.DEAD_HORN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, p)
	);
	...
	public static final Item DROPPER = registerBlock(BlockItemIds.DROPPER, Blocks.DROPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
	...
	public static final Item MUSHROOM_STEW = registerItem(ItemIds.MUSHROOM_STEW, new Item.Properties().stacksTo(1).food(Foods.MUSHROOM_STEW).usingConvertsTo(BOWL));
	...
	public static final Item GOLDEN_LEGGINGS = registerItem(ItemIds.GOLDEN_LEGGINGS, new Item.Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.LEGGINGS));
	...
	public static final Item OAK_HANGING_SIGN = registerBlock(
		BlockItemIds.OAK_HANGING_SIGN, Blocks.OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
	);
	...
	public static final Item CRAFTER = registerBlock(BlockItemIds.CRAFTER, Blocks.CRAFTER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
	...
	public static final Item WRITABLE_BOOK = registerItem(
		ItemIds.WRITABLE_BOOK, WritableBookItem::new, new Item.Properties().stacksTo(1).component(DataComponents.WRITABLE_BOOK_CONTENT, WritableBookContent.EMPTY)
	);
	...
	public static final Item BEETROOT_SOUP = registerItem(ItemIds.BEETROOT_SOUP, new Item.Properties().stacksTo(1).food(Foods.BEETROOT_SOUP).usingConvertsTo(BOWL));
